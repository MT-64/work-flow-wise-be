...
use crate::{env::share_key_secret, error::ErrorResponse};
...
pub fn encode_key(file_id: &str, duration: Expiry) -> Result<String, ErrorResponse> {
...
pub fn decode_key(token: String) -> Result<String, ErrorResponse> {

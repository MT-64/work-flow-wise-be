...
pub fn update_file() -> Router<AppState> {
    async fn update_file_handler(
        ...
        if let Some(data) = data {
            ...
            */
            ...
            return Ok(WebResponse::ok("Updated file successfully", updated_file));
        }
        Ok(WebResponse::ok("Updated file successfully", updated_file))
    }

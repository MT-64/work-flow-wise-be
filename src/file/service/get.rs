...
impl FileService {
    ...
    ) -> Result<Vec<ChildFilesSelect>, ErrorResponse> {
    ...
    pub async fn get_file_by_user_id(
        ...
        user_id: String,
    ) -> Result<FileSelect, ErrorResponse> {
        /*
        ...
        */
        ...
        let collaborator_filter = file_filter
            ...
            .chain(vec![
                ...
                file::collaborators::some(vec![user::pk_user_id::equals(user_id)]),
            ])
            .collect();
    ...
    pub async fn get_files_shared_to_user_id(
        ...
        created_at: Option<DateTime<FixedOffset>>,
        updated_at: Option<DateTime<FixedOffset>>,
    ) -> Result<Vec<FileSelect>, ErrorResponse> {
        let mut filters = vec![];
    ...
    pub async fn get_public_file_by_id(
        &self,
        file_id: String,
    ) -> Result<FileSelect, ErrorResponse> {
    ...
    pub async fn get_file_from_key(&self, key: String) -> Result<FileSelect, ErrorResponse> {

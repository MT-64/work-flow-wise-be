...
impl FolderService {
    ...
    */
    ...
    ) -> Result<Vec<ChildFoldersSelect>, ErrorResponse> {
        //
    ...
    pub async fn get_folders_shared_to_user_id(
        ...
        created_at: Option<DateTime<FixedOffset>>,
        updated_at: Option<DateTime<FixedOffset>>,
    ) -> Result<Vec<FolderSelect>, ErrorResponse> {
        let mut filters = vec![];
        ...
        filters.extend(vec![
            ...
            folder::collaborators::some(vec![user::pk_user_id::equals(user_id)]),
        ]);
    ...
    */
    pub async fn get_folder_by_id(
        &self,
        folder_id: String,
    ) -> Result<child_files_folders::Data, ErrorResponse> {
        let folder = self
            .db
            .folder()
    ...
    */
    pub async fn get_nested_files_from_folder(
        &self,
        folder_id: String,
    ) -> Result<VecDeque<(String, Extension)>, ErrorResponse> {
    ...
    pub async fn get_root_folder(&self, owner_id: String) -> Result<String, ErrorResponse> {
    ...
    pub async fn get_public_folder_by_id(
        &self,
        folder_id: String,
    ) -> Result<FolderSelect, ErrorResponse> {

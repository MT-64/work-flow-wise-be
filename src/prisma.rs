...
pub mod department {
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (pk_department_id, organize_id, name, mut _params): (
                String,
                String,
                String,
                Vec<SetParam>,
...
pub mod organize {
    ...
    pub mod owner_id {
        ...
        pub fn equals(value: Option<String>) -> WhereParam {
            WhereParam::OwnerId(_prisma::read_filters::StringNullableFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::StringNullableFilter,
            OwnerId,
    ...
    pub fn create(
        ...
        (pk_organize_id, name, address, contact, _params)
    }
    pub fn create_unchecked(
        pk_organize_id: String,
        name: String,
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_organize { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: organize struct $ struct_name { # [serde (rename = "pk_organize_id")] pub pk_organize_id : String , # [serde (rename = "owner_id")] # [serde (default , with = "::prisma_client_rust::serde::double_option")] pub owner_id : Option < String > , # [serde (rename = "name")] pub name : String , # [serde (rename = "address")] pub address : String , # [serde (rename = "contact")] pub contact : String } [$ ($ scalar_field) , +] } } ; }
    ...
    pub enum WhereParam {
        ...
        OwnerId(_prisma::read_filters::StringNullableFilter),
        Name(_prisma::read_filters::StringFilter),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(|(pk_organize_id, name, address, contact, mut _params)| {
                    _params.extend([
                        pk_organize_id::set(pk_organize_id),
                        name::set(name),
                        address::set(address),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (pk_organize_id, name, address, contact, mut _params): (
                String,
                String,
                String,
                String,
...
pub mod objective {
    ...
    pub fn create(
        ...
        (pk_objective_id, period, name, target, deadline, _params)
    }
    pub fn create_unchecked(
        pk_objective_id: String,
        period_id: String,
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(
                    |(pk_objective_id, period_id, name, target, deadline, mut _params)| {
                        _params.extend([
                            pk_objective_id::set(pk_objective_id),
                            period_id::set(period_id),
                            name::set(name),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (pk_objective_id, period, name, target, deadline, mut _params): (
                String,
                super::period::UniqueWhereParam,
                String,
                String,
...
pub mod notification {
    ...
    pub fn create(
        ...
        (pk_notification_id, user_id, _params)
    }
    pub fn create_unchecked(
        pk_notification_id: String,
        user_id: String,
    ...
    #[macro_export]
    macro_rules ! _include_notification { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: notification :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: notification :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: notification :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: notification :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: notification :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: notification :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: notification :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: notification :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub pk_notification_id : String , pub user_id : String , pub message : Option < String > , pub status : bool , $ (pub $ field : crate :: prisma :: notification :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (pk_notification_id) , stringify ! (user_id) , stringify ! (message) , stringify ! (status)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: notification :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: notification :: pk_notification_id :: NAME , & self . pk_notification_id) ? ; state . serialize_field (crate :: prisma :: notification :: user_id :: NAME , & self . user_id) ? ; state . serialize_field (crate :: prisma :: notification :: message :: NAME , & self . message) ? ; state . serialize_field (crate :: prisma :: notification :: status :: NAME , & self . status) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , pk_notification_id , user_id , message , status } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: notification :: $ field :: NAME) , + , crate :: prisma :: notification :: pk_notification_id :: NAME , crate :: prisma :: notification :: user_id :: NAME , crate :: prisma :: notification :: message :: NAME , crate :: prisma :: notification :: status :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: notification :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: notification :: pk_notification_id :: NAME => Ok (Field :: pk_notification_id) , crate :: prisma :: notification :: user_id :: NAME => Ok (Field :: user_id) , crate :: prisma :: notification :: message :: NAME => Ok (Field :: message) , crate :: prisma :: notification :: status :: NAME => Ok (Field :: status) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut pk_notification_id = None ; let mut user_id = None ; let mut message = None ; let mut status = None ; while let Some (key) = map . next_key () ? { match key { Field :: pk_notification_id => { if pk_notification_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: notification :: pk_notification_id :: NAME)) ; } pk_notification_id = Some (map . next_value () ?) ; } Field :: user_id => { if user_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: notification :: user_id :: NAME)) ; } user_id = Some (map . next_value () ?) ; } Field :: message => { if message . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: notification :: message :: NAME)) ; } message = Some (map . next_value () ?) ; } Field :: status => { if status . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: notification :: status :: NAME)) ; } status = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: notification :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: notification :: $ field :: NAME)) ? ;) * let pk_notification_id = pk_notification_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: notification :: pk_notification_id :: NAME)) ? ; let user_id = user_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: notification :: user_id :: NAME)) ? ; let message = message . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: notification :: message :: NAME)) ? ; let status = status . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: notification :: status :: NAME)) ? ; Ok (Data { pk_notification_id , user_id , message , status , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["pk_notification_id" , "user_id" , "message" , "status"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: notification :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "Notification" , available relations are "")) } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: notification :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; pk_notification_id) => { "pk_notification_id" } ; (@ field_serde_name ; user_id) => { "user_id" } ; (@ field_serde_name ; message) => { "message" } ; (@ field_serde_name ; status) => { "status" } ; }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(self, data: Vec<(String, String, Vec<SetParam>)>) -> CreateMany<'a> {
            let data = data
                .into_iter()
                .map(|(pk_notification_id, user_id, mut _params)| {
                    _params.extend([
                        pk_notification_id::set(pk_notification_id),
                        user_id::set(user_id),
                    ]);
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (pk_notification_id, user_id, mut _params): (String, String, Vec<SetParam>),
            _update: Vec<SetParam>,
        ) -> Upsert<'a> {
            _params.extend([
                pk_notification_id::set(pk_notification_id),
...
pub mod period {
    ...
    pub fn create(
        ...
        (pk_period_id, name, start_date, end_date, _params)
    }
    pub fn create_unchecked(
        pk_period_id: String,
        name: String,
    ...
    #[macro_export]
    macro_rules ! _include_period { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: period :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: period :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: period :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: period :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: period :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: period :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: period :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: period :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { objective } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub pk_period_id : String , pub name : String , pub start_date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , pub end_date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , $ (pub $ field : crate :: prisma :: period :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (pk_period_id) , stringify ! (name) , stringify ! (start_date) , stringify ! (end_date)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: period :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: period :: pk_period_id :: NAME , & self . pk_period_id) ? ; state . serialize_field (crate :: prisma :: period :: name :: NAME , & self . name) ? ; state . serialize_field (crate :: prisma :: period :: start_date :: NAME , & self . start_date) ? ; state . serialize_field (crate :: prisma :: period :: end_date :: NAME , & self . end_date) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , pk_period_id , name , start_date , end_date } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: period :: $ field :: NAME) , + , crate :: prisma :: period :: pk_period_id :: NAME , crate :: prisma :: period :: name :: NAME , crate :: prisma :: period :: start_date :: NAME , crate :: prisma :: period :: end_date :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: period :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: period :: pk_period_id :: NAME => Ok (Field :: pk_period_id) , crate :: prisma :: period :: name :: NAME => Ok (Field :: name) , crate :: prisma :: period :: start_date :: NAME => Ok (Field :: start_date) , crate :: prisma :: period :: end_date :: NAME => Ok (Field :: end_date) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut pk_period_id = None ; let mut name = None ; let mut start_date = None ; let mut end_date = None ; while let Some (key) = map . next_key () ? { match key { Field :: pk_period_id => { if pk_period_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: period :: pk_period_id :: NAME)) ; } pk_period_id = Some (map . next_value () ?) ; } Field :: name => { if name . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: period :: name :: NAME)) ; } name = Some (map . next_value () ?) ; } Field :: start_date => { if start_date . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: period :: start_date :: NAME)) ; } start_date = Some (map . next_value () ?) ; } Field :: end_date => { if end_date . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: period :: end_date :: NAME)) ; } end_date = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: period :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: period :: $ field :: NAME)) ? ;) * let pk_period_id = pk_period_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: period :: pk_period_id :: NAME)) ? ; let name = name . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: period :: name :: NAME)) ? ; let start_date = start_date . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: period :: start_date :: NAME)) ? ; let end_date = end_date . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: period :: end_date :: NAME)) ? ; Ok (Data { pk_period_id , name , start_date , end_date , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["pk_period_id" , "name" , "start_date" , "end_date" , "Objective"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: period :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; objective : $ selection_mode : ident { $ ($ selections : tt) + }) => { Vec < objective :: Data > } ; (@ field_type ; objective) => { Vec < crate :: prisma :: objective :: Data > } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "Period" , available relations are "objective")) } ; (@ field_module ; objective : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: objective :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; objective $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: period :: IncludeParam > :: into (crate :: prisma :: period :: objective :: Include :: $ selection_mode (crate :: prisma :: objective :: ManyArgs :: new (crate :: prisma :: objective :: include ! (@ filters_to_args ; $ ($ ($ filters) +) ?)) $ ($ (. $ arg ($ ($ arg_params) *)) *) ? , crate :: prisma :: objective :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; objective $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: period :: IncludeParam > :: into (crate :: prisma :: period :: objective :: Include :: Fetch (crate :: prisma :: objective :: ManyArgs :: new (crate :: prisma :: objective :: include ! (@ filters_to_args ; $ ($ ($ filters) +) ?)) $ ($ (. $ arg ($ ($ arg_params) *)) *) ?) ,) } } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: period :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; pk_period_id) => { "pk_period_id" } ; (@ field_serde_name ; name) => { "name" } ; (@ field_serde_name ; start_date) => { "start_date" } ; (@ field_serde_name ; end_date) => { "end_date" } ; (@ field_serde_name ; objective) => { "Objective" } ; }
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_period { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: period struct $ struct_name { # [serde (rename = "pk_period_id")] pub pk_period_id : String , # [serde (rename = "name")] pub name : String , # [serde (rename = "start_date")] pub start_date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "end_date")] pub end_date : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > } [$ ($ scalar_field) , +] } } ; }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(|(pk_period_id, name, start_date, end_date, mut _params)| {
                    _params.extend([
                        pk_period_id::set(pk_period_id),
                        name::set(name),
                        start_date::set(start_date),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (pk_period_id, name, start_date, end_date, mut _params): (
                String,
                String,
                ::prisma_client_rust::chrono::DateTime<::prisma_client_rust::chrono::FixedOffset>,
                ::prisma_client_rust::chrono::DateTime<::prisma_client_rust::chrono::FixedOffset>,
